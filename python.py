...
# Напишите класс Math. Используйте внутри класса магические методы __add__ и __sub__ для сложения и вычитания. После того вы все сделали, создайте экземпляр класса и выведите значения из класса
...
# Напишите класс с использованием геттера и сеттера.
...
# Напишите класс с использованием Множественного Наследования. (С добавлением переопределенных методов и атрибутов к унаследованным моделям объекта)
